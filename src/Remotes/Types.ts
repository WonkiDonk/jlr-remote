 ...
 */
 type CoreVehicleStatus = {
     ...
     DOOR_IS_ALL_DOORS_LOCKED: string,
     ...
     SRS_STATUS: string,
     DOOR_REAR_RIGHT_LOCK_STATUS: string,
     ...
     DOOR_REAR_LEFT_LOCK_STATUS: string,
     ...
     DOOR_ENGINE_HOOD_LOCK_STATUS: string,
